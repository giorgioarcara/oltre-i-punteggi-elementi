...
\node[block1] (A) {\textbf{Sistema}\\ \textbf{Relazionale}\\ \textbf{Empirico}\\ \textit{Costrutto}};

\node[block1, right of=A, xshift=2cm] (B) {\textbf{Sistema}\\ \textbf{Relazionale}\\ \textbf{Numerico}\\ \textit{Punteggio}};
