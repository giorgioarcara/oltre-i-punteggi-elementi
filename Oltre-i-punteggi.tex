...
\begin{verbatim}
Ultima modifica: 2026-07-29 15:10:47 CEST. Versione 0.1.3-alpha
\end{verbatim}
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, opacitybacktitle=0.6, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Definizione}, opacityback=0, leftrule=.75mm, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, rightrule=.15mm, toprule=.15mm, left=2mm, breakable, bottomtitle=1mm, toptitle=1mm, bottomrule=.15mm, colframe=quarto-callout-note-color-frame, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, opacitybacktitle=0.6, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Importante}, opacityback=0, leftrule=.75mm, arc=.35mm, colbacktitle=quarto-callout-important-color!10!white, titlerule=0mm, rightrule=.15mm, toprule=.15mm, left=2mm, breakable, bottomtitle=1mm, toptitle=1mm, bottomrule=.15mm, colframe=quarto-callout-important-color-frame, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, opacitybacktitle=0.6, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Nota}, opacityback=0, leftrule=.75mm, arc=.35mm, colbacktitle=quarto-callout-important-color!10!white, titlerule=0mm, rightrule=.15mm, toprule=.15mm, left=2mm, breakable, bottomtitle=1mm, toptitle=1mm, bottomrule=.15mm, colframe=quarto-callout-important-color-frame, colback=white]
...
\section{Sviluppo di un test secondo la
CTT}\label{sviluppo-di-un-test-secondo-la-ctt}
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, opacitybacktitle=0.6, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Nota}, opacityback=0, leftrule=.75mm, arc=.35mm, colbacktitle=quarto-callout-tip-color!10!white, titlerule=0mm, rightrule=.15mm, toprule=.15mm, left=2mm, breakable, bottomtitle=1mm, toptitle=1mm, bottomrule=.15mm, colframe=quarto-callout-tip-color-frame, colback=white]
...
direttamente ai principi della Classical Test Theory (e in particolare
alla formula \(X = T + E\), vedi il paragrafo
\hyperref[teoria-classica-dei-test]{Teoria Classica dei test}). In
sintesi, la validità risponde alla domanda \emph{cosa stiamo
misurando?}, cioè se il punteggio vero \(T\) rifletta effettivamente il
costrutto che il test intende misurare, mentre l'affidabilità risponde a
\emph{quanto precisamente lo misuriamo?}, cioè quanto è piccola la
componente d'errore \(E\) rispetto al punteggio osservato \(X\). Nei
prossimi paragrafi tratteremo prima la validità e poi, in una sezione
dedicata, l'affidabilità.
...
contesto in cui è utilizzato (questo aspetto sarà ripreso nel paragrafo
``validità di una specifica misurazione'', DA COMPLETARE).
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, opacitybacktitle=0.6, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Non ha senso dire che un test ``è valido''.}, opacityback=0, leftrule=.75mm, arc=.35mm, colbacktitle=quarto-callout-tip-color!10!white, titlerule=0mm, rightrule=.15mm, toprule=.15mm, left=2mm, breakable, bottomtitle=1mm, toptitle=1mm, bottomrule=.15mm, colframe=quarto-callout-tip-color-frame, colback=white]
...
\textbf{continuum}{[}\^{}val{]}, piuttosto che come una proprietà
binaria (valido/non valido): un test accumula, nel tempo e attraverso
diversi studi, un insieme di evidenze a favore (o contro) un determinato
utilizzo, e la nostra fiducia nel test dovrebbe aggiornarsi di
conseguenza.
...
{[}\^{}val{]} Considerando che possono esistere più scopi, forse è più
esatto usare il plurale e dire che le diverse validità sono più
proprietà lungo diversi continuum.

\subsubsection{Validità di facciata}\label{validituxe0-di-facciata}

\begin{tcolorbox}[enhanced jigsaw, coltitle=black, opacitybacktitle=0.6, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Definizione}, opacityback=0, leftrule=.75mm, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, rightrule=.15mm, toprule=.15mm, left=2mm, breakable, bottomtitle=1mm, toptitle=1mm, bottomrule=.15mm, colframe=quarto-callout-note-color-frame, colback=white]

La validità di facciata è il grado in cui un test \textbf{appare} misuri
ciò che intende misurare, sulla base di un giudizio e non di dati
empirici.
...
strumento misuri davvero il costrutto di interesse. Questo può avvenire
...
facciata per la scelta di un test.

\begin{tcolorbox}[enhanced jigsaw, coltitle=black, opacitybacktitle=0.6, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Validità di facciata in ambito forense}, opacityback=0, leftrule=.75mm, arc=.35mm, colbacktitle=quarto-callout-tip-color!10!white, titlerule=0mm, rightrule=.15mm, toprule=.15mm, left=2mm, breakable, bottomtitle=1mm, toptitle=1mm, bottomrule=.15mm, colframe=quarto-callout-tip-color-frame, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, opacitybacktitle=0.6, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Validità di facciata e test neuropsicologici italiani.}, opacityback=0, leftrule=.75mm, arc=.35mm, colbacktitle=quarto-callout-tip-color!10!white, titlerule=0mm, rightrule=.15mm, toprule=.15mm, left=2mm, breakable, bottomtitle=1mm, toptitle=1mm, bottomrule=.15mm, colframe=quarto-callout-tip-color-frame, colback=white]

Nei test neuropsicologici disponibili in Italia, in molti casi l'unica
validità disponibile è purtroppo quella di facciata (quindi quella meno
rigorosa).
...
di validità. Essa si articola tipicamente in tre componenti
complementari:
...
specificate prima di raccogliere i dati oppure andrebbero testate in due
passi: una prima analisi esplorativa su un campione e una seconda
analisi confermativa su un campione indipendente. La
``pre-registrazione'' dei risultati (cioè una registrazione in un punto
sicuro e pubblico delle attese sperimentali) è uno strumento della
\emph{Open Science} che sembra particolarmente utile per una valutazione
della robustezza della validità di costrutto.
...
test. Di seguito riportiamo, a titolo indicativo, alcuni valori soglia
che provengono dall'analisi di Slick
(\cite{slick2006psychometrics})\texttt{\{=latex\}}(Slick, cap. 1 in
Spreen \& Strauss, 2006)`\{=html\}. Una classificazione generale della
grandezza dei coefficienti di affidabilità, che vale come riferimento
orientativo per tutti i tipi di affidabilità trattati di seguito, è la
seguente (Slick, cap. 1):
...
Per le decisioni cliniche, Sattler (\cite{sattler2001assessment} sempre
riportato da \cite{slick2006psychometrics}) propone soglie più
stringenti: per i test usati nella valutazione del singolo individuo si
raccomanda un'affidabilità pari o superiore a .80; per i test usati per
decisioni particolarmente importanti (per esempio la stima del QI o una
diagnosi), .90 è considerato il minimo assoluto, e .95 il valore
ottimale.
...
Valori indicativi per la consistenza interna (Slick, cap. 1): valori
inferiori a .70 sono considerati inaccettabili, tra .70 e .79 discreti,
tra .80 e .89 buoni, e pari o superiori a .90 eccellenti. Nei test
neuropsicologici la consistenza interna tende però ad essere più bassa
della media, spesso intorno a .60, in parte perché molti di questi test
valutano domini eterogenei di abilità piuttosto che un singolo costrutto
omogeneo (Slick, cap. 1).
...
Valori indicativi (Cicchetti \& Sparrow, 1981, citati
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, opacitybacktitle=0.6, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Come documentarsi}, opacityback=0, leftrule=.75mm, arc=.35mm, colbacktitle=quarto-callout-tip-color!10!white, titlerule=0mm, rightrule=.15mm, toprule=.15mm, left=2mm, breakable, bottomtitle=1mm, toptitle=1mm, bottomrule=.15mm, colframe=quarto-callout-tip-color-frame, colback=white]
