...
\begin{verbatim}
Ultima modifica: 2026-08-01 17:33:32 CEST. Versione 0.2.1
\end{verbatim}
...
\item
  Sezioni speciali: \emph{Focus}, \emph{Nella pratica clinica},
  \emph{Errori comuni}
\end{itemize}
...
\textbf{10. Fondamenti della Neuropsicologia Clinica: Scopi, Misurazione
e Giustificazione delle Inferenze Cliniche}
...
\section*{\texorpdfstring{Sezioni speciali: \emph{Focus}, \emph{Nella
pratica clinica}, \emph{Errori
comuni}}{Sezioni speciali: Focus, Nella pratica clinica, Errori comuni}}\label{sezioni-speciali-focus-nella-pratica-clinica-errori-comuni}
\addcontentsline{toc}{section}{Sezioni speciali: \emph{Focus},
\emph{Nella pratica clinica}, \emph{Errori comuni}}

\markright{Sezioni speciali: \emph{Focus}, \emph{Nella pratica clinica},
\emph{Errori comuni}}
...
\item
  Le sezioni \emph{``Focus''} approfondiscono in maniera più dettagliata
  alcuni argomenti o curiosità storiche, teoriche, tecniche, o di altro
  tipo.
\end{itemize}
...
migliore attività clinica (si veda il paragrafo \emph{``Fondamenti della
neuropsicologia clinica: scopi, misurazione e giustificazione delle
inferenze cliniche''} per ulteriori dettagli). La misurazione, cioè
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm, opacityback=0, coltitle=black, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, leftrule=.75mm, colback=white, toprule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Definizione}, titlerule=0mm, arc=.35mm, breakable, rightrule=.15mm, bottomtitle=1mm, toptitle=1mm]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, colbacktitle=quarto-callout-important-color!10!white, bottomrule=.15mm, opacityback=0, coltitle=black, colframe=quarto-callout-important-color-frame, opacitybacktitle=0.6, leftrule=.75mm, colback=white, toprule=.15mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Importante}, titlerule=0mm, arc=.35mm, breakable, rightrule=.15mm, bottomtitle=1mm, toptitle=1mm]
...
livelli di prestazione media/medio-alta\footnote{per complicare
  ...
  trattato in un \hyperref[Focus-item-arbitrari]{Focus}).}. Per chi
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, colbacktitle=quarto-callout-important-color!10!white, bottomrule=.15mm, opacityback=0, coltitle=black, colframe=quarto-callout-important-color-frame, opacitybacktitle=0.6, leftrule=.75mm, colback=white, toprule=.15mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Nota}, titlerule=0mm, arc=.35mm, breakable, rightrule=.15mm, bottomtitle=1mm, toptitle=1mm]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, colbacktitle=quarto-callout-tip-color!10!white, bottomrule=.15mm, opacityback=0, coltitle=black, colframe=quarto-callout-tip-color-frame, opacitybacktitle=0.6, leftrule=.75mm, colback=white, toprule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Nota}, titlerule=0mm, arc=.35mm, breakable, rightrule=.15mm, bottomtitle=1mm, toptitle=1mm]
...
che ogni strumento di misurazione (non solo psicologica) può essere più
o meno precise, e nella vita quotidiana ci regoliamo di conseguenza. Un
geometra che deve rilevare un muro non si affida a un metro pieghevole,
ma a un rilevatore laser. Per misurare con esattezza la temperatura di
un bambino è preferito comunque il termometro ascellare, scomodo ma
preciso, al termometro auricolare, che fornisce una lettura più rapida
ma spesso considerata meno stabile. Gli esempi si potrebbero
moltiplicare, ma il principio resta lo stesso: quando una misurazione è
rilevante, scegliamo gli strumenti che riteniamo più adeguati.

\begin{figure}[H]

{\centering \includegraphics[width=0.8\linewidth,height=\textheight,keepaspectratio]{chapters/../Figures/termometri.png}
...
Su questo semplice principio si fonda il presente capitolo. Anche i test
...
Una domanda che automaticamente verrebbe da porsi è: come faccio a
capire se il mio test è sufficientemente valido o sufficientamente
affidabile per poterlo utilizzare? Questa domanda non ha una risposta
semplice e non esistono dei criteri unanimamente condivisi. Per ogni
tipo di validità e affidabilità, se pertinente sono riportate alcune
soglie minime indicative di quegli indici che sono utilizzate per
valutarle (la fonte principale è \cite{slick2006psychometrics}). Tali
soglie sono appunto da considerare solo come ``indicative''. Come usare
i valori di affidabilità e validità per selezionare un test è trattato
in dettaglio alla fine nel capitolo, nel paragrafo
\hyperref[prat-clin-aff-val]{Nella pratica clinica: Come usare
affidabilità e validità per scegliere i test}
...
unanimamente accettata di validità. Di seguito ne è riportata una che ne
cattura bene l'essenza principale.
...
«costrutto» (questo aspetto sarà ripreso nel paragrafo
\hyperref[focus-validituxe0-misurazione]{Focus: validità di una
specifica misurazione}).
...
test ha evidenze di validità per un certo scopo, in una certa
popolazione, in un certo contesto. Uno stesso test di memoria può avere
buone evidenze di validità per identificare un decadimento cognitivo in
soggetti anziani, e nessuna evidenza per, ad esempio, predire il
rendimento scolastico in età evolutiva.

\begin{tcolorbox}[enhanced jigsaw, left=2mm, colbacktitle=quarto-callout-tip-color!10!white, bottomrule=.15mm, opacityback=0, coltitle=black, colframe=quarto-callout-tip-color-frame, opacitybacktitle=0.6, leftrule=.75mm, colback=white, toprule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Non ha senso dire che un test ``è valido''.}, titlerule=0mm, arc=.35mm, breakable, rightrule=.15mm, bottomtitle=1mm, toptitle=1mm]
...
Un altro motivo per evitare affermazioni come ``quel test è valido/non
valido'' è che la validità non è una proprietà tutto o nulla, ma una
proprietà lungo un \textbf{continuum}\footnote{Considerando che possono
  esistere più scopi, forse sarebbe più esatto usare il plurale e dire
  che le diverse validità sono più proprietà lungo diversi continuum.}:
un test accumula, nel tempo e attraverso diversi studi, un insieme di
evidenze a favore (o contro) un determinato utilizzo, e la nostra
fiducia nel test dovrebbe aggiornarsi di conseguenza.

Proprio per via della complessità spesso vengono riconosciuti diversi
tipi di validità, ognuno in grado di cogliere aspetti diversi del test.
Inutile dire che anche in questo caso non esiste una classificazione
unanimamente riconosciuta. Questa complessità del concetto di validità e
delle sue classificaizoni è perfettamente testimoniata dai cambiamenti
tra le due edizioni di ``Essentials of Psychological Testing'' di Susana
Urbina (uno dei testi più diffusi sul testing psicologico), in cui la
sezione sulla validità ha avuto una grande revisione
(\cite{urbina2004essentials}; \cite{urbina2014essentials}).

Quella che troverete di seguito è quindi solo una delle possibili
classificazioni di validità, selezionata per la sua rilevanza in ambito
neuropsicologico. Una prima importante distinzione è tra validità a
priori e validità a posteriori. Le validità \textbf{a priori} (di
facciata e di contenuto) si valutano analizzando il contenuto del test
stesso, prima ancora di somministrarlo e raccogliere dati. Le validità
\textbf{a posteriori} (di costrutto, di criterio ed ecologica)
richiedono invece la raccolta di dati empirici, tipicamente confrontando
il punteggio del test con altre misure esterne oppure analizzando il
comportamento ai diversi item dello strumento.
...
davvero il costrutto di interesse. Essa è infatto spesso considerata
come una proprietà importante semplicemente perché è un requisito per la
collaborazione del paziente e nella sua motivazione ad affrontare il
test (\cite{slick2006psychometrics}).

Un test però, potrebbe non essere un buono strumento di misurazione
nonostante un'apparente \emph{validità di facciata} per diversi motivi:
potrebbero esserci strategie alternative per affrontare il test che non
si basano sulla funzione cognitiva attesa, le istruzioni potrebbero
essere poco chiare, gli item del test potrebbero non comportarsi come
dovrebbero per dei motivi che possono sfuggire ad una semplice analisi
qualitativa.
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, colbacktitle=quarto-callout-tip-color!10!white, bottomrule=.15mm, opacityback=0, coltitle=black, colframe=quarto-callout-tip-color-frame, opacitybacktitle=0.6, leftrule=.75mm, colback=white, toprule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Validità di facciata in ambito forense}, titlerule=0mm, arc=.35mm, breakable, rightrule=.15mm, bottomtitle=1mm, toptitle=1mm]
...
è desiderabile che il test non abbia una elevata validità di facciata.

\end{tcolorbox}

{\vspace{1cm}}

\begin{tcolorbox}[enhanced jigsaw, left=2mm, colbacktitle=quarto-callout-tip-color!10!white, bottomrule=.15mm, opacityback=0, coltitle=black, colframe=quarto-callout-tip-color-frame, opacitybacktitle=0.6, leftrule=.75mm, colback=white, toprule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Validità di facciata come unico tipo di validità.}, titlerule=0mm, arc=.35mm, breakable, rightrule=.15mm, bottomtitle=1mm, toptitle=1mm]

Nei manuali o articoli scientifici di alcuni test neuropsicologici
potrebbe non essere presente alcun tipo di validità. In tal caso, è come
se fosse disponibile solo la validità di facciata. Nel valutare la bontà
del test, possiamo basarci solo sulla sua apparenza. Questa situazione,
...
appropriato. (si veda Focus: affidabilità e validità nei test
...
:::\{.callout-note\} \#\# Definizione La validità di contenuto è il
grado in cui gli item di un test coprono in modo adeguato e
rappresentativo tutti gli aspetti rilevanti di ciò che si intende
misurare (spesso del costrutto). :::

Un test con buona validità di contenuto campiona in modo sistematico
l'intero dominio del costrutto. Ad esempio, un test per la patente di
guida che simula molte condizioni di guida reali (traffico urbano,
manovre, situazioni di emergenza) ha una validità di contenuto migliore
di un test che valuta solo la conoscenza teorica del codice della
strada. Al contrario, un test di lettura composto da sole parole isolate
ha una validità di contenuto scarsa se lo scopo è valutare la
...
più famoso è certamente il \emph{Delphi Consensus}, un metodo
tradizionalmente utilizzato per definire linee guida cliniche
(\cite{devries2018screening}). Questo è un metodo strutturato fatto da
passi espliciti per raggiungere un accordo tra più esperti, che permette
di identificare se gli item sono adeguati e anche se mancano item
importanti all'interno del test. Come strategia alternativa, talvolta
per la valutazione della validità di contenuto sono presenti dei report
quantitativi, esclusivamente descrittivi che raccolgono, che si basano
su domande e scale Likert create ad-hoc per raccogliere le opinioni
degli esperti sul test. Nei test neuropsicologici italiani la validità
di contenuto è riportata raramente in modo esplicito: tra le eccezioni
vi sono l'ABaCo (\cite{sacco2008abaco}) e l'APACS
...
soglia in funzione del numero di giudici coinvolti, Per il Delphi
consensus non esiste una soglia specifica, ma essa deve essere
esplicitata all'inizio (in genere può essere necessario l'accordo di
almeno 80\% degli esperti per mantenere un item all'interno del test)

\subsubsection{Validità di costrutto}\label{validituxe0-di-costrutto}

La validità di costrutto è spessa considerata come la più importante
delle validità.
...
Dal momento che nella psicometria l'oggetto principale è la misurazione
di costrutti, non è sorprendente che la validità di costrutto sia
considerata il principale tipo di validità. Alcune classificazioni di
fatto considerano tutte le validità come nient'altro che diverse
sfaccettature della validità di
costrutto(\cite{slick2006psychometrics}). Essa viene tipicamente
classificata in due componenti complementari:
...
Con questo nome si intende la capacità del punteggio del test di
convergere o divergere in maniera coerente con il costrutto con altre
misure.
...
\item
  ...
  teoricamente vicini. Ad esempio, un test di memoria è atteso che
  correli con altri test di memoria. Un test di abilità di comprensione
  del linguaggio, avrebbe evidenza di validità di costrutto se il
  punteggio correlasse con un altro test che misura abilità di
  comprensione del testo scritto (che è una parte della comprensione del
  linguaggio).
\item
...
senza essere imprecisi. Per tale ragione sono approfondite nella sezione
di Approfondimenti tecnici. In breve, un'analisi fattoriale per essere a
supporto della validità di costrutto dovrebbe mostrare che gli item del
test si comportano in modo coerente con il costrutto. L'analisi
fattoriale è infatti spesso utilizzata in fase di sviluppo dei test,
come strumento statistico per selezionare quali item tenere e quali
invece escludere dalla versione finale. Esistono diverse metriche per
valutare l'adeguatezza del modello fattoriale e diversi valori soglia
proposti in letteratura legati. Si rimanda al paragrafo su analisi
fattoriale negli approfondimenti tecnici per i dettagli.

\subsubsection{Risultati coerenti con il
costrutto}\label{risultati-coerenti-con-il-costrutto}

Ogni evidenza che il punteggio al test si comporta in maniera adeguata
secondo la teoria legata al costrutto può di fatto essere considerata
come evidenza a favore della validità di costrutto\footnote{questa
  ultima tipologia di validità di costrutto è qui riportata per mostrare
  come anche altre tipologie di evidenze possono essere considerate come
  supporto alla validità di costrutto. Ad un occhio attento, con questa
  definizione però abbracciamo di fatto \emph{tutte} le possibili
  validità di costrutto.}. Questo può avvenire anche se il test correla
in maniera coerente con la teoria con altri costrutti diversi (magari
con una correlazione debole o moderata) o addirittura se il punteggio
correla con altre variabili che non siano costrutti. Per esempio un test
di memoria che però si assumi coinvolga anche l'attenzione, avrebbe
supporto a validità di costrutto se mostrasse una debole correlazione
con l'attenzione. Oppure un test su abilità di calcolo in età scolare
avrebbe validità di costrutto se correlasse con la media di voti in
matematica. Relazioni coerenti con il costrutto ossono anche essere
legate a variabili demografiche. Ad esempio se i punteggi ad un test
mostrano una correlazione positiva con l'età e la teoria prevede che il
punteggio al test vari con l'età, quest'ultima può essere considerata
un'evidenza di validità di costrutto.

La validità di costrutto e in particolare la struttura fattoriale, sono
spesse associate al concetto di \emph{invarianza di misura}, la
proprietà di un test di misurare la stessa cosa anche in diverse
condizioni (ad esempio in diverse popolazioni di pazienti). Questo
aspetto è leggermente approfondito nel paragrafo
\hyperref[invarianza-intro]{Focus: Invarianza di misura nei test
neuropsicologici} e più in dettaglio nel capitolo dedicato degli
\emph{Approfondimenti tecnici}. {]}

\emph{Soglie indicative}: Anche per questo tipo di validità non esistono
soglie minime, anche perché non esiste un'analisi specifica per
valutarla (qualsiasi analisi che mostri la coerenza dei punteggi con la
teoria legata al costrutto sarebbe adeguata). I valori che sono ritenuti
a supporto della validità dovrebbero però essere motivati e
accompagnati, preferibilmente, da una pre-registrazione che di chiare i
valori minimi considerati come a supporto (o meno) del fatto che il test
stia effettivamente misurando il costrutto oggetto del test.

\subsection{Validità di criterio}\label{validituxe0-di-criterio}

In alcuni casi, la validità di un test viene valutata esaminando la
relazione tra i suoi punteggi e una variabile esterna direttamente
osservabile, denominata \emph{criterio}. Si parla allora di
\textbf{validità di criterio}.

\begin{tcolorbox}[enhanced jigsaw, left=2mm, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm, opacityback=0, coltitle=black, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, leftrule=.75mm, colback=white, toprule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Definizione}, titlerule=0mm, arc=.35mm, breakable, rightrule=.15mm, bottomtitle=1mm, toptitle=1mm]

La validità di criterio indica il grado in cui i punteggi di un test
risultano associati a un criterio esterno rilevante, misurabile e, per
quanto possibile, stabilito indipendentemente dal test stesso.

\end{tcolorbox}

Nel contesto della neuropsicologia clinica, il criterio può essere
rappresentato da una variabile continua oppure categoriale.

Nel primo caso, il criterio può essere, per esempio, il punteggio
ottenuto mediante una procedura di valutazione più lunga e approfondita.
Talvolta questa procedura viene considerata un \emph{gold standard},
ossia il migliore metodo disponibile per valutare una determinata
condizione o raggiungere una specifica conclusione clinica. Tuttavia, un
altro test non costituisce automaticamente un \emph{gold standard}:
perché possa fungere da criterio, deve possedere adeguate evidenze di
validità ed essere sufficientemente indipendente dal test che si intende
valutare.

La validità di criterio viene frequentemente studiata nei test di
screening. Lo scopo di questi strumenti può essere, per esempio,
prevedere l'esito di una valutazione neuropsicologica più estesa oppure
discriminare tra persone appartenenti a differenti categorie
diagnostiche, come persone con \emph{Mild Cognitive Impairment} e
persone cognitivamente sane.

Quando si verifica se i punteggi di un test differiscono tra gruppi
definiti \emph{a priori} sulla base di informazioni indipendenti --- per
esempio diagnosi già formulate mediante altre procedure --- si parla di
\textbf{validità per gruppi noti} (\emph{known-groups validity}). A
seconda del modello teorico adottato, questa evidenza può essere
ricondotta alla validità di criterio oppure considerata una forma di
evidenza a sostegno della validità di costrutto.

Anche in questo caso la classificazione di diversi tipi di validità è
variabile. In questa sede adottiamo la classificazione di Slick
(\cite{slick2006psychometrics}), che considera di fatto la known-groups
validity come parte della criterion validity.

In base alla relazione temporale tra la somministrazione del test e la
rilevazione del criterio, si distinguono tradizionalmente la validità
concorrente e la validità predittiva.

\subsubsection{Validità concorrente}\label{validituxe0-concorrente}

Si parla di \textbf{validità concorrente} quando il test e il criterio
vengono misurati nello stesso momento, o comunque a una distanza
temporale sufficientemente breve da rendere improbabile un cambiamento
rilevante nella condizione esaminata.

Un esempio è rappresentato dalla relazione tra il punteggio ottenuto a
un breve test di screening e l'esito di una batteria neuropsicologica
più approfondita somministrata nella stessa sessione.

Quando il criterio è categoriale, la validità concorrente può essere
indagata verificando se i punteggi del test discriminano condizioni
diagnostiche stabilite approssimativamente al momento della valutazione.
Il MoCA (\cite{nasreddine2005montreal}) e il MMSE
(\cite{folstein1975mini}), per esempio, sono stati originariamente
studiati anche valutando la capacità dei loro punteggi di distinguere
gruppi con differenti condizioni cognitive.

In ambito forense, evidenze di questo tipo vengono utilizzate anche
nello sviluppo di strumenti finalizzati a discriminare prestazioni
credibili e non credibili o a identificare la possibile
\emph{simulazione} di deficit cognitivi. L'argomento sarà approfondito
nel capitolo dedicato.

\subsubsection{Validità predittiva}\label{validituxe0-predittiva}

Si parla invece di \textbf{validità predittiva} quando il criterio
esterno viene rilevato in un momento successivo rispetto alla
somministrazione del test.

Un esempio è rappresentato da un punteggio neuropsicologico rilevato ad
una prima valutazione e utilizzato per predire la diagnosi di demenza a
due anni di distanza. Analogamente, uno screening scolastico può essere
valutato in base alla sua capacità di predire gli esiti degli
apprendimenti alla fine dell'anno.

Il criterio futuro può essere anche categoriale. Per esempio, il ritorno
al lavoro dopo uno \emph{stroke} può essere codificato come esito
dicotomico (\emph{sì/no}). Valutare se il punteggio ottenuto a un test
somministrato nella fase iniziale sia in grado di predire la probabilità
di un successivo reinserimento lavorativo costituisce un'indagine della
validità predittiva del test.

\emph{Soglie indicative}: Non esiste una soglia universale oltre la
quale la validità di criterio possa essere considerata automaticamente
adeguata. L'interpretazione dipende dalla natura del criterio, dalla
finalità del test, dalla qualità della misura di riferimento e dalle
conseguenze delle decisioni che verranno prese sulla base del punteggio.

Quando il criterio è continuo, la relazione viene spesso espressa
mediante un coefficiente di correlazione. Valori pari o superiori a
0.70--0.80 possono essere considerati elevati in molti contesti
applicativi, ma non rappresentano requisiti universalmente validi.

Quando il criterio è categoriale, possono essere utilizzati indici quali
sensibilità, specificità e area sotto la curva ROC. Anche in questo
caso, valori pari o superiori a 0.80 sono talvolta proposti come
indicativamente adeguati, ma la loro interpretazione deve tenere conto
dello scopo del test, della prevalenza della condizione e dei costi
associati ai falsi positivi e ai falsi negativi. Questi indici e la
scelta dei punteggi di soglia saranno approfonditi nei capitoli
dedicati.
...
attività della vita quotidiana (ADL/IADL), questionari compilati dal
paziente o da un caregiver o altri indici che sono relativi alla vita
quotidiana (es. numero di comportamenti inappropriati).

La validità ecologica è raramente disponibile, in parte perché
raccogliere dati sul funzionamento quotidiano reale è più difficile e
costoso che raccogliere altri tipi di evidenza (come la relazione con
altri test). È però una dimensione particolarmente rilevante in
neuropsicologia clinica e forense, dove l'obiettivo ultimo della
valutazione è spesso proprio stabilire l'impatto di un deficit cognitivo
sul funzionamento della persona nella vita reale, al di fuori
dell'ambulatorio e del setting di valutazione.

\emph{Soglia indicativa}: non esiste un valore soglia condiviso in
letteratura per giudicare la validità ecologica come sufficiente, anche
perché non esiste un'analisi standard. Spesso sono riportate
correlazioni o analisi di regressione (es.
(\cite{higginson2000ecological}))
...
in diverse misurazioni; può essere intesa come la precisione di un test.
...
{\centering \includegraphics[width=0.7\linewidth,height=\textheight,keepaspectratio]{chapters/../Figures/affidabilità_validità.png}
...
Come abbiamo già visto per la validità una domanda comune è:
l'affidabilità del mio test è sufficiente alta? Questa è una domanda
delicata in cui la risposta dipenda anche dal tipo di utilizzo che si
intende fare con il test. Di seguito è riportata una classificazione
generale della grandezza dei coefficienti di affidabilità, che vale come
riferimento orientativo per tutti i tipi di affidabilità trattati di
seguito (\cite{slick2006psychometrics}):
...
Anche in questo caso le soglie sono da considerare come indicative: per
le decisioni cliniche, Sattler (\citeyear{sattler2001assessment})
...
quando l'affidabilità è al di sotto di valori raccomandati (si veda
anche il paragrafo \hyperref[prat-clin-aff-valux5cux257D]{Nella pratica
clinica: Come usare affidabilità e validità per scegliere i test}.
...
L'affidabilità split-half indica la consistenza di un test quando si
confrontano il punteggio totale ottenuto da metà degli item con il
punteggio totale ottenuto con gli altri item.
...
La consistenza interna rappresenta tuttora uno dei principali approcci
alla stima dell'affidabilità nell'ambito della teoria classica dei test.
Per la sua definizione la consistenza interna è un concetto a cavallo
tra affidabilità e validità (ed è legata alla struttura fattoriale del
test). L'indice più diffuso per calcolare la consistenza interna è
l'alpha di Cronbach (\(\alpha\)), che varia da 0 a 1 e può essere
pensato, in modo intuitivo, come la media di tutte le possibili
affidabilità split-half calcolabili su quel test (cfr. paragrafo
successivo). Un'alternativa più recente, e in generale considerata più
robusta, è l'omega di McDonald (\(\omega\))\footnote{Dettagli su
  \(\alpha\) e \(\omega\), e le formule per calcolarli, sono trattate
  più in dettaglio nella sezione \emph{Approfondimenti tecnici}.}.
...
\subsubsection{Affidabilità
test--retest}\label{affidabilituxe0-testretest}

\begin{tcolorbox}[enhanced jigsaw, left=2mm, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm, opacityback=0, coltitle=black, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, leftrule=.75mm, colback=white, toprule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Definizione}, titlerule=0mm, arc=.35mm, breakable, rightrule=.15mm, bottomtitle=1mm, toptitle=1mm]

L'affidabilità test--retest riguarda la stabilità dei punteggi ottenuti
quando lo stesso test viene somministrato alle stesse persone in due
occasioni diverse, assumendo che nell'intervallo tra le somministrazioni
non si siano verificati cambiamenti reali nel costrutto misurato e che
le condizioni di valutazione siano comparabili.

\end{tcolorbox}

L'affidabilità test--retest è una delle principali aspetti di
affidabilità di un test e in numerosi casi è proprio considerato il più
importante (\cite{slick2006psychometrics}). Questo dipo di affidabilità
ha però una serie di caratteristiche e sfumature che è importante
approfondire per una corretta interpretazione. Innanzitutto
l'affidabilità test-retest, del resto come altre proprietà, non è una
proprietà univoca e immutabile del test: la sua stima dipende dalla
popolazione considerata, dalle condizioni di somministrazione e,
soprattutto, dall'intervallo tra test e retest. Due aspetti meritano
...
\tightlist
\item
  \textbf{Dipendenza dall'intervallo}: uno stesso punteggio non possiede
  un unico valore di affidabilità test--retest. In genere, il
  coefficiente tende a essere più elevato quando l'intervallo è breve,
  mentre intervalli più lunghi aumentano la possibilità che si
  verifichino cambiamenti reali nella caratteristica misurata
  (\cite{slick2006psychometrics}).
\item
  \textbf{Effetto pratica}: quando il test misura una prestazione, la
  seconda somministrazione può beneficiare dell'esperienza acquisita
  durante la prima. Un miglioramento sistematico può non essere rilevato
  da alcuni indici comunemente utilizzati per quantificare
  l'affidabilità test--retest, come il coefficiente di correlazione o
  una ICC basata sulla consistenza (\cite{slick2006psychometrics}).
\end{enumerate}

In ambito clinico, l'affidabilità test--retest è particolarmente
rilevante quando si assume che il punteggio rappresenti una
caratteristica relativamente stabile oppure quando si vogliono
confrontare valutazioni effettuate in momenti diversi. Tuttavia, il solo
coefficiente di affidabilità non permette di stabilire se la variazione
osservata nel singolo individuo sia sufficientemente ampia da superare
l'errore di misurazione. A questo scopo sono necessarie procedure
specifiche, eventualmente corretti per l'effetto pratica (si veda
paragrafo \emph{indagare cambiamenti nel tempo}).

\begin{tcolorbox}[enhanced jigsaw, left=2mm, colbacktitle=quarto-callout-tip-color!10!white, bottomrule=.15mm, opacityback=0, coltitle=black, colframe=quarto-callout-tip-color-frame, opacitybacktitle=0.6, leftrule=.75mm, colback=white, toprule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Rilevanza per una singola misurazione}, titlerule=0mm, arc=.35mm, breakable, rightrule=.15mm, bottomtitle=1mm, toptitle=1mm]

Contrariamente a quanto si potrebbe pensare, l'affidabilità test--retest
non è importante soltanto quando si vogliono confrontare due misurazioni
effettuate nel tempo. Se il punteggio è interpretato come misura di una
caratteristica relativamente stabile, la singola somministrazione può
essere concepita come una delle molte possibili somministrazioni
comparabili del test. Nella teoria classica dei test, il \emph{punteggio
vero} corrisponde infatti al valore atteso dei punteggi che la persona
otterrebbe attraverso un numero indefinito di misurazioni equivalenti.

Una bassa affidabilità test--retest indica quindi che il punteggio
dipende in misura rilevante dalla specifica occasione in cui è stato
rilevato. Di conseguenza, anche quando il test viene somministrato una
sola volta, il punteggio osservato può rappresentare con scarsa
precisione la caratteristica stabile che si intende misurare.

\end{tcolorbox}

L'affidabilità test--retest viene spesso quantificata mediante il
coefficiente di correlazione tra i punteggi al test e al retest oppure
mediante un coefficiente di correlazione intraclasse (\emph{intraclass
correlation coefficient}, ICC).

Il coefficiente di correlazione esprime principalmente la
\emph{consistenza relativa} tra le due misurazioni, ossia il grado in
cui le persone mantengono un ordinamento simile nelle due occasioni. Una
correlazione può quindi essere molto elevata anche quando i punteggi al
retest sono sistematicamente più alti, per esempio a causa di un effetto
pratica. Per questo motivo, quando l'affidabilità test--retest è
espressa mediante una correlazione, il coefficiente dovrebbe essere
accompagnato dall'analisi di eventuali cambiamenti sistematici tra le
due somministrazioni, per esempio attraverso il confronto tra le medie e
l'esame della distribuzione delle differenze (\cite{arcara2016apacs}).

La ICC non è un singolo coefficiente, ma una famiglia di coefficienti.
Quelle più pertinenti nel caso dell'affidabilità test-retest sono le ICC
basate sull'\textbf{accordo assoluto}, che tengono conto delle
differenze sistematiche tra test e retest e sono quindi più sensibili
alla presenza di un effetto pratica.

Nel tipico disegno test--retest, nel quale le due occasioni sono
prestabilite e (approssimativamente) identiche per tutti i partecipanti,
viene generalmente raccomandato un modello a due vie, a effetti misti,
basato sull'accordo assoluto e riferito a una singola
misurazione{[}\^{}ICC\_det{]}.
(\cite{shrout1979intraclass})(\cite{mcgraw1996forming}; \cite{koo2016guideline}).
Per un approfondimento sull'affidabilità test--retest, sull'effetto
pratica e sulle differenze tra correlazione e ICC, si veda la sezione
\emph{Approfondimenti tecnici}.

\emph{Soglie indicative}: non esiste una soglia universalmente valida.
Un coefficiente pari o superiore a .70 viene talvolta considerato un
requisito minimo per finalità di ricerca o per confronti tra gruppi.
Quando il punteggio contribuisce a decisioni importanti sul singolo
individuo, sono generalmente richiesti valori più elevati: spesso almeno
...
fluenza verbale, test di disegno, o compiti di descrizione, oppure
compiti di interpretazione di proverbi.

Si esprime tipicamente con l'Intraclass Correlation Coefficient (ICC)
che, come anticipato nel precedente paragrafo, perché tiene conto anche
dell'accordo assoluto tra i valutatori (cioè se assegnano più o meno lo
stesso punteggio), e non solo di quanto i loro punteggi si muovono
insieme (Fastenau et al., 1996, (\cite{slick2006psychometrics})). Più
specificamente, nei tipico disegno sperimentali usati per definire la
affidabilità inter-rater, andrebbe usato lo un modello analogo a quello
già specificato per affidabilità test-retest
(\cite{shrout1979intraclass}; \cite{koo2016guideline}). Si veda il
paragrafo su Intra-class correlation della sezione \emph{Approfondimenti
tecnici} per ulteriori dettagli.
...
(\cite{slick2006psychometrics}) \\
Inter-rater & ICC & ≥ .60 buono; ≥ .75 eccellente & Cicchetti \&
Sparrow, 1981; Fastenau et al., 1996 \\
\end{longtable}

\section[\raisebox{-0.5em}{} Nella pratica clinica: Come usare
affidabilità e validità per scegliere i
test]{\texorpdfstring{\raisebox{-0.5em}{\protect\includegraphics[width=\linewidth,height=1.5em,keepaspectratio]{./Figures/clinical_practice.png}}
Nella pratica clinica: Come usare affidabilità e validità per scegliere
i
test}{ Nella pratica clinica: Come usare affidabilità e validità per scegliere i test}}\label{prat-clin-aff-val}
...
2005 (\cite{appollonio2005frontal}), ha visto pubblicare nuove evidenze
psicometriche in Aiello et al.~(2022) (\cite{aiello2022frontal}), quasi
vent'anni dopo. Vale quindi la pena cercare, oltre all'articolo
originale, anche altri studi successivano che lo citano (per esempio
tramite Google Scholar o PubMed) e che ne approfondiscono le proprietà
psicometriche, per verificare se sono emerse nuove evidenze in
popolazioni o contesti diversi. è da notare che non è raro che alcune
...
\pandocbounded{\includegraphics[keepaspectratio]{chapters/Validita-Affidabilita_files/figure-pdf/fig-CTT-true-obs-1.pdf}}

}

\caption{\label{fig-CTT-true-obs}Valutare validità e affidabilità di un
test neuropsicologico: piuttosto che basarsi su soglie, è spesso utile
scegliere i test in maniera comparativa, e cioè quelli con proprietà
migliori}

\end{figure}%

\begin{tcolorbox}[enhanced jigsaw, left=2mm, colbacktitle=quarto-callout-important-color!10!white, bottomrule=.15mm, opacityback=0, coltitle=black, colframe=quarto-callout-important-color-frame, opacitybacktitle=0.6, leftrule=.75mm, colback=white, toprule=.15mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Il fatto che un test sia pubblicato non garantisce che abbia validità e
affidabilità sufficienti.}, titlerule=0mm, arc=.35mm, breakable, rightrule=.15mm, bottomtitle=1mm, toptitle=1mm]
...
\section[\raisebox{-0.5em}{} Focus: imprecisione dei test e intervalli
di
confidenza.]{\texorpdfstring{\raisebox{-0.5em}{\protect\includegraphics[width=\linewidth,height=1.5em,keepaspectratio]{./Figures/target.png}}
Focus: imprecisione dei test e intervalli di
confidenza.}{ Focus: imprecisione dei test e intervalli di confidenza.}}\label{imprecisione}

Le formule dell'affidabilità permetterebbero facilmente la restituzione
di informazion sull'incertezza di una misura. Immaginate che un paziente
ottenga un punteggio di 16 ad un test. Adesso immaginate di aggiungere
delle misure di incertezza alla stessa misura nella forma di intervalli
che comunichino l'incertezza della misura: \(16\ [10-26]\) oppure
\(16\ [12-24]\). Lo stesso valore puntuale (16) assume nei due scenari
significati molto diversi. Nel secondo scenario, associato ad una
maggiore incertezza rispetto al primo, probabilmente le nostre
intepretazioni saranno più caute. Tecnicamente, questo è facilmente
possibile a partire dai valori di affidabilità, tramite semplice
applicazioni di formule e numeri che abbiamo definito. Anche se
esprimere esplicitamente l'incertezza della misura è qualcosa a cui gli
psicometristi sono molto legati, ho preferito non inserire una
trattazione approfondita in questa sezione del libro per adeguarmi
maggioramente ciò che accade nella pratica clinica. Ad oggi non esistono
modi (se non qualitativi), di tenere conto dell'incertezza di misura
espressa di intervalli di confidenza. Presentarle senza integrazioni ad
indicazioni applicative, rischia di creare solo confusione in chi vuole
utilizzare queste informazioni. Approfondimenti sugli intervalli di
confidenza che si possono ottenere a partire da misurazione e sullo
\emph{Standard Error of Measurement} (SEM) sono presenti nella sezione
\emph{Approfondimenti tecnici}.

\section[\raisebox{-0.5em}{} Focus: Dalla validità di un test alla
validità di una specifica
valutazione]{\texorpdfstring{\raisebox{-0.5em}{\protect\includegraphics[width=\linewidth,height=1.5em,keepaspectratio]{./Figures/target.png}}
Focus: Dalla validità di un test alla validità di una specifica
valutazione}{ Focus: Dalla validità di un test alla validità di una specifica valutazione}}\label{focus-validituxe0-misurazione}

Nel corso del capitolo si è più volte parlato, per semplicità, della
validità come di una proprietà del test. In senso rigoroso, tuttavia,
questa formulazione è imprecisa. Secondo la concezione oggi prevalente,
infatti, la validità riguarda il grado in cui la teoria e le evidenze
disponibili sostengono una determinata interpretazione dei punteggi per
uno specifico uso e in uno specifico contesto, e non il test considerato
in astratto. Di conseguenza, nemmeno un test supportato da solide
evidenze di validità può garantire che ogni punteggio ottenuto sia
interpretabile allo stesso modo.

Immaginiamo, per esempio, un test di memoria dotato di ottime proprietà
psicometriche e di solide evidenze a sostegno dell'interpretazione dei
suoi punteggi. Supponiamo però di somministrarlo a un paziente
fortemente oppositivo nei confronti della valutazione, che decide di non
impegnarsi nei compiti proposti. Un eventuale punteggio basso non
potrebbe essere interpretato automaticamente come indicatore di un
deficit di memoria, perché la prestazione potrebbe riflettere
soprattutto lo scarso coinvolgimento nella prova. Ciò non annulla le
evidenze di validità accumulate per il test; indica, piuttosto, che le
inferenze abitualmente tratte dai suoi punteggi non sono giustificate in
quella specifica somministrazione. La qualità psicometrica dello
strumento e l'interpretabilità dei dati ottenuti nel singolo caso
costituiscono quindi condizioni distinte, ma entrambe necessarie.

Questa distinzione è comunemente tenuta in considerazione in
neuropsicologia forense, ma è anche considerata importante in contesto
clinico (sebbene non altrettanto diffusa). Il \emph{performance validity
testing} comprende procedure e indicatori volti a valutare se la
prestazione osservata possa essere considerata una rappresentazione
credibile delle capacità della persona esaminata. Questo è appunto
rilevante in ambito forense, in cui possono suggerire che una persona
stia deliberatamente simulando un deficit. Il Capitolo 7 è
specificamente dedicato a queste procedure e al loro ruolo nella
valutazione della simulazione.

\section[\raisebox{-0.5em}{} Focus: Invarianza di misura nei test
neuropsicologici]{\texorpdfstring{\raisebox{-0.5em}{\protect\includegraphics[width=\linewidth,height=1.5em,keepaspectratio]{./Figures/target.png}}
Focus: Invarianza di misura nei test
neuropsicologici}{ Focus: Invarianza di misura nei test neuropsicologici}}\label{invarianza-intro}

Un tema fondamentale della psicometria, che meriterebbe un capitolo a
sé, è quello dell' \emph{invarianza di misura}. Con questa espressione
si indica un insieme di condizioni in base alle quali, rispetto a
specifici gruppi, contesti od occasioni di misurazione, la relazione tra
il costrutto e le prestazioni osservate rimane sufficientemente stabile
da consentire le inferenze o i confronti di interesse.

L'invarianza non è una proprietà assoluta del test, ma deve essere
valutata empiricamente rispetto a determinate popolazioni e nell'ambito
di uno specifico modello di misura. Come al solito, è quindi più
corretto parlare di evidenze a favore dell'invarianza che considerare un
test invariante in generale. Inoltre, l'invarianza non implica che
gruppi differenti debbano ottenere gli stessi punteggi: indica,
piuttosto, che le eventuali differenze non dipendono da un diverso
funzionamento dello strumento. Il livello di invarianza necessario
dipende però dall'inferenza che si vuole formulare: riconoscere nei
diversi gruppi la medesima struttura generale del costrutto richiede
condizioni meno stringenti rispetto al confronto quantitativo dei
punteggi o delle medie.

Per esempio, un test di memoria utilizzato sia con persone sane sia con
persone con malattia di Alzheimer presenta il livello di invarianza
necessario al confronto quando la relazione tra l'abilità mnestica e le
prestazioni osservate rimane sufficientemente stabile nei due gruppi.
Non ci si aspetta, naturalmente, che essi ottengano gli stessi
risultati, ma che i punteggi conservino un significato comparabile. Lo
studio di Chang e Brainerd (2021) (\cite{chang2021factor}) sulla
batteria neuropsicologica dell'ADNI mostra bene come questa condizione
non possa essere data per scontata: gli autori hanno riscontrato una
struttura fattoriale generale simile tra controlli sani, persone con
decadimento cognitivo lieve e persone con malattia di Alzheimer, ma non
livelli più stringenti di invarianza tra i gruppi diagnostici.

L'invarianza di misura costituisce un tema particolarmente delicato per
i test neuropsicologici per almeno due ragioni. La prima è che, per
molti strumenti, la struttura fattoriale di riferimento è stata ricavata
prevalentemente da campioni normativi di persone sane, mentre le
verifiche formali dell'invarianza rispetto alle popolazioni cliniche
rimangono relativamente poco frequenti. Non è quindi possibile assumere
automaticamente che il modello di misura e il significato dei punteggi
rimangano invariati nelle diverse condizioni cliniche.

La seconda ragione è che alcune condizioni rendono particolarmente
plausibile un diverso funzionamento delle prove. Si consideri, per
esempio, il MoCA, uno strumento di screening cognitivo generale,
somministrato a persone con grave afasia. Le richieste linguistiche di
diversi compiti possono influenzare il risultato, facendo sì che il
punteggio totale rifletta non soltanto il funzionamento cognitivo
generale, ma anche le abilità di compromissione linguistica. Il problema
può essere formulato propriamente in termini di invarianza quando si
verifica empiricamente se le prove funzionino in maniera
sistematicamente diversa tra gruppi di persone con e senza afasia. Nella
pratica clinica tuttavia, questa possibilità viene spesso affrontata
attraverso l'interpretazione qualitativa della singola prestazione e le
conoscenze teoriche del neuropsicologo, senza che siano necessariamente
disponibili verifiche psicometriche formali.

L'argomento sarà ripreso nella sezione ``Approfondimenti tecnici'', nel
capitolo dedicato all'invarianza di misura.

\section[\raisebox{-0.5em}{} Errori comuni: ignorare validità e
affidabilità di un
test]{\texorpdfstring{\raisebox{-0.5em}{\protect\includegraphics[width=\linewidth,height=1.5em,keepaspectratio]{./Figures/error_warning.png}}
Errori comuni: ignorare validità e affidabilità di un
test}{ Errori comuni: ignorare validità e affidabilità di un test}}\label{errori-comuni-ignorare-validituxe0-e-affidabilituxe0-di-un-test}
...
\item
  le sezioni inizialmente definite come ``Approfondimenti e Curiosità''
  sono state rinominate come ``Focus''.
\end{itemize}
