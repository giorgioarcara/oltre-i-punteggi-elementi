...
\begin{verbatim}
Ultima modifica: 2026-07-29 08:11:11 CEST. Versione 0.1.2
\end{verbatim}
...
\textbf{1. Psicometria per la Neuropsicologia clinica} * Perché è
importante misurare? * Misurazione e neuropsicologia clinica * Quale
definizione di misurazione adottano i test neuropsicologici? * I test *
Tipologie di test * Test di prestazione massima * Test di comportamento
tipico * Teoria Classica dei Test * Validità ed Affidabilità * Validità
* Affidabilità * Sviluppo di test tramite Teoria Classica dei Test *
Oltre la Teoria Classica dei Test * Nella pratica clinica: Come usare
Affidabilità e Validità per scegliere i test * Nella pratica clinica:
Come usare Affidabilità e Validità per interpretare i test * Errori
comuni nel considerare gli aspetti psicometrici dei test * Capitolo 1:
Riassunto
...
un Test in maniera consapevole significa anche conoscere quanto funziona
...
galinstan (i termometri a mercurio non esistono più), fornisce una
misura più precisa di utilizzare un termometro digitale da orecchio. Lo
stesso principio dovrebbe valere per i test neuropsicologici, dovremmo
sempre scegliere quelli che hanno le migliori qualità di misura (o
conoscerne quantomeno i loro limiti). Questo influenza le
interpretazioni che possiamo trarne ed è definito in gran parte dalle
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-note-color-frame, coltitle=black, arc=.35mm, toptitle=1mm, rightrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, left=2mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Definizione}, breakable, leftrule=.75mm, colback=white, bottomtitle=1mm, titlerule=0mm, bottomrule=.15mm, toprule=.15mm, opacitybacktitle=0.6, opacityback=0]
...
determinate regole.''} (\cite{stevens1946measurement}) - p.~667
...
psicometria è quella di Suppes e Zinnes (\cite{suppes1963basic}) . A
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-important-color-frame, coltitle=black, arc=.35mm, toptitle=1mm, rightrule=.15mm, colbacktitle=quarto-callout-important-color!10!white, left=2mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Importante}, breakable, leftrule=.75mm, colback=white, bottomtitle=1mm, titlerule=0mm, bottomrule=.15mm, toprule=.15mm, opacitybacktitle=0.6, opacityback=0]
...
in dettaglio nel \hyperref[Capitolo2]{Capitolo 2}). Tuttavia, vi sono
...
le \emph{correzioni} per età e scolarità, trattate nel capitolo 2 e
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-important-color-frame, coltitle=black, arc=.35mm, toptitle=1mm, rightrule=.15mm, colbacktitle=quarto-callout-important-color!10!white, left=2mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Nota}, breakable, leftrule=.75mm, colback=white, bottomtitle=1mm, titlerule=0mm, bottomrule=.15mm, toprule=.15mm, opacitybacktitle=0.6, opacityback=0]
...
Index questionnaire}; (\cite{nucci2012cognitive})), un questionario in
cui si raccolgono informazioni su anni di istruzione, attività
lavorativa e attività del tempo libero nel corso della vita. Il CRIq non
è un test di prestazione massima: non si chiede al paziente di fare del
proprio meglio su un compito, ma di riportare informazioni anamnestiche
strutturate.
...
che è troppo semplice, che 7 parole sono poche{[}\^{}pochiitems{]}, che
30 secondi sono pochi, che le parole sono troppo facili, etc. Tutte
queste considerazioni sono ragionevoli e probabilmente condivisibili, ma
non sono basate su aspetti tecnici o su effettive verifiche sulla
qualità del test. Sono semplicemente basate sul buon senso e
sull'esperienza clinica. {[}\^{}pochiitems{]}: Il numero di item da solo
non è un indicatore della qualità di un test. Esistono test pubblicati e
validati anche con pochissimi item: per esempio, esiste una versione a 3
item della \emph{UCLA Loneliness Scale} per la misurazione
((\cite{gosling2024measuring})).
...
\subsection{Riassunto sulla CTT}\label{riassunto-sulla-ctt}
...
saranno trattati in dettaglio nei paragrafi successivi.

\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-tip-color-frame, coltitle=black, arc=.35mm, toptitle=1mm, rightrule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, left=2mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Nota}, breakable, leftrule=.75mm, colback=white, bottomtitle=1mm, titlerule=0mm, bottomrule=.15mm, toprule=.15mm, opacitybacktitle=0.6, opacityback=0]
...
\section{Sviluppo di test secondo
CTT}\label{sviluppo-di-test-secondo-ctt}
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-tip-color-frame, coltitle=black, arc=.35mm, toptitle=1mm, rightrule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, left=2mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Il mio test è adeguato?}, breakable, leftrule=.75mm, colback=white, bottomtitle=1mm, titlerule=0mm, bottomrule=.15mm, toprule=.15mm, opacitybacktitle=0.6, opacityback=0]

Per alcuni tipi di validità e affidabilità la letteratura riporta valori
soglia indicativi, ma non esiste un criterio universalmente condiviso
per stabilire quando un test sia ``adeguato''. Per questo motivo, più
che chiedersi se un test sia sufficiente o insufficiente, conviene
ragionare in termini comparativi: un test ha più o meno evidenze di
validità e affidabilità, ed è migliore o peggiore rispetto alle
alternative disponibili per lo stesso scopo. I valori soglia riportati
in questo capitolo vanno quindi letti come orientamenti pratici, non
come standard assoluti, in linea con l'idea di un continuum Peggio ↔
Meglio, piuttosto che di una dicotomia netta.

\end{tcolorbox}

Validità e affidabilità sono le due proprietà fondamentali a cui fare
riferimento per stabilire se un test è un buon test, e si collegano
direttamente al principio cardine della CTT (\(X = T + E\); cfr.
paragrafo \emph{Il principio cardine: X = T + E}). La validità risponde
alla domanda \emph{cosa stiamo misurando?}, cioè se il punteggio vero
\(T\) rifletta effettivamente il costrutto che il test intende misurare.
L'affidabilità risponde invece alla domanda \emph{quanto precisamente lo
misuriamo?}, cioè quanto è piccola la componente d'errore \(E\) rispetto
al punteggio osservato \(X\). Nei prossimi paragrafi tratteremo prima la
validità e poi, in una sezione dedicata, l'affidabilità.

\subsection{Validità: definizione}\label{validituxe0-definizione}
...
\emph{``La validità è il grado in cui un test misura effettivamente il
costrutto che intende misurare.''} (\cite{nunnally1994psychometric})

\end{tcolorbox}

Un aspetto spesso trascurato è che la validità non è una proprietà
generale e assoluta di un test, ma è sempre riferita a un
\textbf{utilizzo specifico}: non ha senso dire semplicemente che ``un
test è valido'', mentre ha senso dire che un test è valido per un certo
scopo, in una certa popolazione, in un certo contesto. Uno stesso test
di memoria può avere buone evidenze di validità per identificare un
decadimento cognitivo in soggetti anziani, e nessuna evidenza per, ad
esempio, predire il rendimento scolastico in età evolutiva.

Come per l'affidabilità, anche la validità è più utile pensarla come un
\textbf{continuum}, piuttosto che come una proprietà binaria (valido/non
valido): un test accumula, nel tempo e attraverso diversi studi, un
insieme di evidenze a favore (o contro) un determinato utilizzo, e la
nostra fiducia nel test dovrebbe aggiornarsi di conseguenza.
...
La validità di facciata è il grado in cui un test \textbf{sembra}
misurare ciò che intende misurare, sulla base di un giudizio
superficiale e non di dati empirici.
...
La validità di facciata è la forma di validità meno rigorosa: viene
valutata solo qualitativamente, senza alcuna analisi statistica.
Talvolta è l'unica evidenza disponibile per un test, ma la sua
plausibilità superficiale non è sufficiente per concludere che lo
strumento misuri davvero il costrutto di interesse\footnote{Un esempio
  didattico spesso usato per illustrare questo punto è quello di un
  ipotetico ``questionario di qualità psicologica'' (QMP), che appare
  del tutto plausibile a prima vista, ma che una volta verificato
  empiricamente si rivela inaffidabile e privo di reali evidenze di
  validità.}.

\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-tip-color-frame, coltitle=black, arc=.35mm, toptitle=1mm, rightrule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, left=2mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Nota}, breakable, leftrule=.75mm, colback=white, bottomtitle=1mm, titlerule=0mm, bottomrule=.15mm, toprule=.15mm, opacitybacktitle=0.6, opacityback=0]

In ambito forense vale, per certi versi, il ragionamento opposto: i test
progettati per rilevare la simulazione (\emph{malingering}) non devono
avere validità di facciata. Se il paziente comprende immediatamente che
lo strumento valuta la sincerità delle sue risposte, la sua utilità
clinica viene meno.
...
un testo, perché non campiona aspetti come la coesione tra frasi o
l'inferenza.

Oltre al giudizio qualitativo di esperti, esiste anche un approccio
quantitativo alla validità di contenuto, proposto da Lawshe
(\cite{lawshe1975quantitative}): un gruppo di giudici esperti valuta
ogni singolo item, e le loro valutazioni vengono aggregate in un indice
per item (\emph{Content Validity Ratio}, CVR) e in un indice complessivo
per il test (\emph{Content Validity Index}, CVI)\footnote{Il calcolo del
  CVR e del CVI, così come le tabelle con i valori soglia in funzione
  del numero di giudici coinvolti, sono trattati più in dettaglio nella
  sezione \emph{Approfondimenti tecnici}.}. Nei test italiani la
validità di contenuto è riportata raramente in modo esplicito; tra le
eccezioni vi sono l'ABaCo (Sacco et al., 2008) e l'APACS (Arcara \&
Bambini, 2016).
...
Si articola tipicamente in tre componenti complementari:

\begin{itemize}
\tightlist
\item
  \textbf{Validità convergente}: il punteggio del test correla con altre
  misure dello stesso costrutto, o di costrutti teoricamente vicini.
\item
  \textbf{Validità divergente (o discriminante)}: il punteggio del test
  mostra una correlazione bassa con misure di costrutti teoricamente
  distinti. Per esempio, un test di autonomia funzionale come la NADL-F
  dovrebbe correlare pochissimo con una scala di depressione come la
  GDS, se i due strumenti misurano davvero costrutti diversi.
\item
  ...
  verificato con l'analisi fattoriale esplorativa (EFA) o confermativa
  (CFA), talvolta con un cenno all'analisi delle componenti principali
  (PCA). Anche in questo caso, ciò che conta ai fini della validità è
  che il raggruppamento empirico degli item rispecchi le dimensioni
  teoriche attese, più dei dettagli tecnici della procedura statistica
  utilizzata.
\end{itemize}

Per la validità di costrutto non esiste un valore soglia universale (una
correlazione convergente ``abbastanza alta'' o divergente ``abbastanza
bassa''), il che la rende, tra i tipi di validità, quella più esposta al
rischio di flessibilità interpretativa post-hoc: è facile, guardando i
dati a posteriori, trovare una spiegazione plausibile per qualunque
pattern di correlazioni osservato. Per questo motivo, le ipotesi su
quali correlazioni ci si aspetta di trovare (e quali no) andrebbero
specificate prima di raccogliere i dati, per esempio tramite
...
presenza dello stesso strumento. Per un criterio continuo, in
letteratura si trovano tipicamente valori attesi di correlazione pari o
superiori a 0.70-0.80.
...
Un aspetto distinto, ma strettamente collegato, riguarda la qualità
metodologica degli studi con cui si raccolgono le evidenze di validità:
si parla in questo caso di \textbf{validità interna} del disegno di
ricerca. Se lo studio che raccoglie le evidenze presenta dei
confondimenti, le conclusioni sulla validità del test diventano meno
solide. Per esempio, in uno studio di validità concorrente in cui il
gruppo di pazienti e il gruppo di controllo differiscono
sistematicamente per età o scolarità, un'eventuale differenza nei
punteggi al test potrebbe riflettere queste variabili di confondimento,
piuttosto che il costrutto che il test intende misurare.

La validità interna si contrappone alla \textbf{validità esterna}, cioè
alla generalizzabilità dei risultati di uno studio ad altri contesti,
popolazioni o momenti temporali. Un disegno di ricerca con alta validità
interna, ma condotto su un campione molto specifico, può avere scarsa
validità esterna, e viceversa.
...
Contenuto & Giudizio di esperti; CVR/CVI (Lawshe, 1975) & Dipende dal
numero di giudici \\
...
I valori soglia riportati in questo paragrafo sono \textbf{indicativi e
non universali}: la letteratura non è unanime, e non è raro che test
pubblicati e ampiamente utilizzati circolino con valori di affidabilità
ben al di sotto di quelli raccomandati (\cite{slick2006psychometrics}).
...
affidabilità trattati di seguito, è la seguente (Slick, cap. 1):

\begin{longtable}[]{@{}ll@{}}
\caption{Classificazione generale della grandezza dei coefficienti di
affidabilità (Slick, cap. 1 in Spreen \& Strauss,
2006).}\label{tbl-affidabilita-generale}\tabularnewline
\toprule\noalign{}
...
Per le decisioni cliniche, Sattler (\cite{sattler2001assessment})
propone soglie più stringenti: per i test usati nella valutazione del
singolo individuo si raccomanda un'affidabilità pari o superiore a .80;
per i test usati per decisioni particolarmente importanti (per esempio
la stima del QI o una diagnosi), .90 è considerato il minimo assoluto, e
.95 il valore ottimale.
...
Valori indicativi per la consistenza interna (Cicchetti et al., 1990,
citato in Slick, cap. 1): valori inferiori a .70 sono considerati
...
abilità piuttosto che un singolo costrutto omogeneo (Slick, cap. 1).
...
una misura di affidabilità appropriata (Slick, cap. 1).
...
tipicamente con un coefficiente di correlazione o con un Intraclass
Correlation Coefficient (ICC; cfr. paragrafo su Inter-Rater Agreement).

Valori indicativi: pari o superiori a .70 (Andrews et al., 1994;
Burlingame et al., 1995, citati in Slick, cap. 1); per le decisioni
cliniche sul singolo individuo si raccomanda .80 (Sattler, 2001).
...
\item
  ...
  sistematico del livello medio dei punteggi (Slick, cap. 1).
\end{enumerate}
...
Valori indicativi: pari o superiori a .70-.80 (Slick, cap. 1).
...
i loro punteggi si muovono insieme (Fastenau et al., 1996, citati in
Slick, cap. 1).

Valori indicativi (Cicchetti \& Sparrow, 1981, citati in Slick, cap. 1):
inferiori a .40 scarsi, tra .40 e .59 discreti, tra .60 e .74 buoni,
pari o superiori a .75 eccellenti. Con una classificazione lievemente
diversa, Fastenau et al.~(1996) considerano .60 come soglia per un
accordo ``sostanziale'' e .75-.80 per un accordo ``quasi perfetto''.
...
Sattler (2001) per le decisioni cliniche sul singolo individuo (≥ .80; ≥
.90 per le decisioni ad alto
...
\subsection{Come faccio a sapere se il mio test è
adeguato?}\label{come-faccio-a-sapere-se-il-mio-test-uxe8-adeguato}

\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-tip-color-frame, coltitle=black, arc=.35mm, toptitle=1mm, rightrule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, left=2mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Come documentarsi}, breakable, leftrule=.75mm, colback=white, bottomtitle=1mm, titlerule=0mm, bottomrule=.15mm, toprule=.15mm, opacitybacktitle=0.6, opacityback=0]

\begin{itemize}
\tightlist
\item
  \textbf{Il primo posto in cui cercare} è il manuale del test, oppure
  l'articolo originale con cui lo strumento è stato presentato: è lì che
  si trovano le evidenze di validità e affidabilità raccolte dagli
  autori al momento della pubblicazione.
\item
  \textbf{Le evidenze non si esauriscono con la pubblicazione}: un test
  può accumulare nuove prove di validità e affidabilità anche molti anni
  dopo la sua uscita. Per esempio, la Frontal Assessment Battery (FAB),
  pubblicata da Appollonio et al.~nel 2005, ha visto pubblicare nuove
  evidenze psicometriche in Aiello et al.~(2022), quasi vent'anni dopo.
  Vale quindi la pena cercare, oltre all'articolo originale, anche gli
  \textbf{studi successivi} che lo citano (per esempio tramite Google
  Scholar o PubMed), per verificare se sono emerse nuove evidenze in
  popolazioni o contesti diversi.
\item
  \textbf{Il fatto che un test sia pubblicato, anche da autori esperti,
  non garantisce di per sé nulla}: uno strumento pubblicato può comunque
  avere una bassa affidabilità, o nessuna evidenza di validità per lo
  specifico utilizzo che se ne vuole fare. Valutare criticamente queste
  evidenze fa parte del lavoro di chi utilizza il test in ambito
  clinico.
\end{itemize}
...
validità e affidabilità si accumulano nel tempo, e vanno lette come un
continuum piuttosto che come un giudizio definitivo: usare oggi un test
con prove ancora limitate non equivale automaticamente a usare un test
``non valido'', ma significa muoversi verso il polo peggiore del
continuum. È anche per questo motivo che l'aggiornamento professionale
continuo è così rilevante in questo ambito: nuove prove pubblicate nel
tempo possono spostare la valutazione complessiva di uno strumento, in
meglio o in peggio.
