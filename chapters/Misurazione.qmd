...
[^ctt-meas]: si noti che anche la teoria classica dei test che può essere a sua volta pensata come un modello di misurazione `(\cite{borsboom2005measuring})`{=latex}`Borsboom (2005)`{=html}. 
