...
| **Ordinale** | Classificazione con ordine, ma le distanza tra categorie non hanno significato   | Classifica di gara, Livello di istruzione (scuola) | Ordinamento, mediane, percentili                     |
...
| **Rapporto** | Misura con ordine, intervalli uguali e lo zero ha un significato          | Peso, Altezza, Età, Reddito     | Tutte le operazioni aritmetiche (×, ÷, +, −), z-score, rapporti|
...
Di fatto, nella maggior parte dei test neuropsicologici _si assume_ che la misura sia su una Scala a intervalli o a rapporti ma, come sarà ripreso nei paragrafi, [**Misurare Cambiamenti nel  Tempo**](chapters/Appendici/Cambiamenti-nel-tempo.qmd#misurare_cambiamenti) e [**Introduzione all'_Item Response Theory_**](#introduzione-item-response-theory)), questa è un'assunzione che potrebbe non essere rispettata rendendo questo utilizzo improprio.
