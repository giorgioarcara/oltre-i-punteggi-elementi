...
L'ottenere una correzione per età e scolarità presuppone che si possa sottrarre il contributo di queste variabili al punteggio in modo che i valori di individui con età e scolarità diverse siano comparibili (questo argomento sarà approfondito nel [Capitolo 2](#chapters/Identificare-deficit)). Ad esempio, se il mio punteggio originale è 8, ma il contributo stimato di età, scolarità e sesso di un individuo è 3, per rimuoverlo devo sottrarlo e il punteggio corretto sarà 8-3=5. Questo operazione (di correzione) ha senso solo se la scale è a misurata a livello di scala ad intervalli o scala a rapporti. Se non lo fosse, la mia operazione sarebbe sbagliata e potrebbe portarmi ad un errore di utilizzo del punteggio e della sua interpretazione.
...
La disciplina che si occupa della misurazione in psicologia è la _psicometria_, una delle materie (insieme alla statistica), che sono il fondamento di questo libro. La psicometria si occupa proprio delle questioni della misurazione in psicologia, una tipologia di misurazione molto particolare perchè non tratta di proprietà di oggetti fisici ma di concetti psicologici e la relazione tra ciò che è l'esito della misura (cioè il punteggio) e cioè che si vuole misurare, cioè il costrutto è  molto indiretto. Il fatto che ci sia un'intera disciplina dedicato a questo sottolinea una cosa importante: che la misurazione in psicologia è un argomento complesso che non può essere banalizzato.
