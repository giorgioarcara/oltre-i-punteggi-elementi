...
(La neuropsicologia la misurazione è spesso di costrutti non osservabili come memoria, attenzione, etc.)
:::

La neuropsicologia tramite test e misurazione non si occupa però solo di costrutti, ma anche di altri aspetti, più legati alla medicina in generale. Ne è un esempio il rischio di sviluppare una patologia. Alcuni test restituiscono come risultato proprio delle probabilità e in questo caso l'oggetto di interesse non è dunque un costrutto.
