...
### La situazione pratica: X si vede, T no

Nella pratica clinica, però, osserviamo soltanto $X$. Il punteggio vero $T$ è per definizione non osservabile — è, a tutti gli effetti, un **costrutto**, esattamente come la memoria o l'attenzione discusse nei paragrafi precedenti. Di $T$ non vediamo mai il valore diretto: possiamo solo stimarlo a partire da $X$, sapendo che tra i due si frappone sempre una quota di errore.
