...
Questa definizione ha il vantaggio di essere ampia e inclusiva: si applica tanto ai test cognitivi quanto ai questionari di personalità, alle scale di autovalutazione e a molti altri strumenti di misura in ambito psicologico. Tuttavia, presenta un limite importante per i nostri scopi: non fa riferimento al **costrutto** che si vuole misurare. Come discusso nel [paragrafo precedente](#cosa-misuriamo-in-neuropsicologia-clinica), in neuropsicologia l'interesse non è nel comportamento in sé (le risposte del paziente agli item del test) bensì nel costrutto che quel comportamento indica. Il punteggio è un indicatore indiretto di qualcosa di non direttamente osservabile (memoria, attenzione, funzioni esecutive, ecc.), non il costrutto stesso.
