...
### Costrutti misurati dai test neuropsicologici
- intro su quali sono i costrutti? 
- test eteroegenei e non esiste un chiaro riferimento: ci sono talvolta domini, ma non esiste (se non in libri come Lezak), un elenco comprensivo di domini.
- altri costrutti sono più vaghi e utilizzati in clinica. Es. FAB.
- eterogeneità legata ad epistemologia (rimanda).

### Riassunto sulla CTT <!-- valutare se mantenere questo paragrafo o se accorpare con riassunto finale-->
