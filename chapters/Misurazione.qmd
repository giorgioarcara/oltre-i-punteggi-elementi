...
Alcune operazioni con questi numeri sono intuitivamente sensate, ad esempio possiamo dire che alcune persone hanno più memoria di altre (possiamo quindi ordinare), ma nel momento in cui cerchiamo di capire l'applicabilità di altre operazioni diventa più difficile rispondere. Ad esempio, tramite un test possiamo arrivare a dire che una persona ha il doppio di memoria di un altra? Oppure che ha +20 unità di memoria più di un'altra? (qualsiasi sia questa unità). Rispetto alla definizione di Suppes & Zinnes questo potrebbe essere possibile o no ed è una dei possibili esiti ed è attraverso la specificazione della _struttura assiomatica della relazione empirica_[^supp] che si stabilisce quale relazione esista tra costrutto e punteggio e quali operazioni siano giustificate.
