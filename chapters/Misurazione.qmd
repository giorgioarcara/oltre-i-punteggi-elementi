...
Quanto appena detto è, in sostanza, quello che abbiamo già trattato nel [paragrafo iniziale sulla misurazione](#cosa-misuriamo-in-neuropsicologia-clinica)
Riprendiamo questo esempio e approfondiamolo ancora una volta. La situazione di una misurazione indiretta potrebbe sembrare non troppo diversa da quella dell'esempio del termometro: del resto la temperatura non è direttamente osservabile, ma è legata a un indicatore osservabile (l'espansione del galinstan o mercurio) che ci permettono di ottenere un numero (i gradi) che rappresenta indirettamente ciò che vogliamo misurare. 
