...
-->
### Riassunto sulla CTT
Abbiamo descritto brevemente il principio cardine della CTT e alcune assunzioni di fondo di questo framework teorico. Abbiamo però anche detto che spesso questo non è detto esplicitamente. Il segno più chiaro dell'utilizzo di questo framework è legato alla domanda di chiusura che ci siamo posti "come fare a decidere se un test è un buon test"? Per farlo la CTT, risponde che bisogna avere informazioni sulla **validità** del test (la giustificazione del legame tra punteggio e costrutto) e la sua **affidabilità** (la precisione e la consistenza della misura). Questi sono gli aspetti più critici della psicometria nel contesto della CTT e saranno trattati in dettaglio nei prossimi paragrafi.
